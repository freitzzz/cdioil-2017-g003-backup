 ...
 */
public class CSVQuestionsReader implements QuestionssReader {
     ...
     */
    @Override
    public int readQuestoes(GlobalLibrary globalLibrary, Manager manager) {
        int nrCatNI = 0;
        ...
        if (nrCatNI++ != 0) {
            System.out.println("Não foram importadas " + nrCatNI + " questões, porque as categorias não lhe pertencem.");
            return 4;
        }
        return 3;
    }
