        ...
        for (int i = LINHA_IDENTIFICADOR + 1; i < conteudoFicheiro.size(); i++) {
            ...
            if (line.length != 0) { //Não lê linhas sem informação
                ...
                se adiciona novas categorias.*/
                    Category pai = new Category(line[1], line[0] + Category.Sufixes.SUFIX_DC);
                    boolean added = em.adicionarCategoriaRaiz(pai);
                    if (added) {
                        categorias.add(pai);
                    }

                    Category filha1 = new Category(line[3], line[2]
                    ...
                    Category filha2 = new Category(line[5], line[4]
                    ...
                    Category filha3 = new Category(line[7], line[6]
                    ...
                    Category filha4 = new Category(line[9], line[8]
