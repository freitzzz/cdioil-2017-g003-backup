 ...
 *!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 * =============================================================================
 * FIXME - After fixing the methods in CSVQuestionsReader class, comment out
 * the tests
 * =============================================================================
 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
//
//        BinaryQuestionOption binaryOption1 = new BinaryQuestionOption(Boolean.FALSE);
//        BinaryQuestionOption binaryOption2 = new BinaryQuestionOption(Boolean.TRUE);
//        LinkedList<QuestionOption> binaryOptionList = new LinkedList<>();
//        binaryOptionList.add(binaryOption1);
//        binaryOptionList.add(binaryOption2);
//        List<Question> key1Values = new LinkedList<>();
//        Question q1 = new BinaryQuestion("Bla, bla?", "12",binaryOptionList);
//        key1Values.add(q1);
//        Question q2 = new BinaryQuestion("Bla, bla, bla?", "13",binaryOptionList);
//        key1Values.add(q2);
...
//        
//        Question q5 = new BinaryQuestion("Blo, blo, blo?", "15",binaryOptionList);
//        key3Values.add(q5);
//        
...
//        binaryOptionList.add(binaryOption1);
//        binaryOptionList.add(binaryOption2);
//        Question q1 = new BinaryQuestion("Já adquiriu produtos de marca Continente?", "A34",binaryOptionList);
//        expected.add(q1);
//        QuantitativeQuestionOption quantitativeOption1 = new QuantitativeQuestionOption(0.0);
//        QuantitativeQuestionOption quantitativeOption2 = new QuantitativeQuestionOption(1.0);
//        QuantitativeQuestionOption quantitativeOption3 = new QuantitativeQuestionOption(2.0);
