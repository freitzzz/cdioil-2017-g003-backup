...
public class ProdutoTest {
    ...
    @Before
    public void setUp() {
        this.p = new Produto("ProdutoTeste", new EAN("544231234"), new QRCode("4324235"));
    }
    ...
    public void testToString() {
        ...
        Produto copia = new Produto("ProdutoTeste", new EAN("544231234"), new QRCode("4324235"));
    ...
    public void testEquals() {
        ...
        assertNotEquals("Instância de Produto diferente", new Produto("ProdutoTeste", new EAN("33312118"), new QRCode("552671")), p);
        assertEquals("Instância com códigos iguais igual", new Produto("ProdutoTeste", new EAN("544231234"), new QRCode("4324235")), p);
    }
