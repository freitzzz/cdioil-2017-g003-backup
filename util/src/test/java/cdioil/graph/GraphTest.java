...
public class GraphTest {
    ...
    public void testEndVertices() {
        ...
        assertNull("End vertices of null parameter should return null",instance.endVertices(null));
        
        Vertex<String, String> dummyOrigin = new Vertex<>(0, "Not in the graph");
        Vertex<String, String> dummyDestination = new Vertex<>(1, "Not in the graph either");
        Edge<String, String> dummyEdge = new Edge<>("", 0, dummyOrigin, dummyDestination);
        assertNull("Since neither edge nor the vertices have been added to the graph, the result should be null",instance.endVertices(dummyEdge));
    ...
    public void testOpposite() {
        ...
        String string = "I'm not in the graph.";
        assertNull("Result should be null, since Object was not added to the graph",instance.opposite(string, edge8));
    }
    ...
    public void testOutDegree() {
        ...
        assertFalse("Duplicate vertex should not be added", instance.insertVertex("A"));
    ...
    public void testOutgoingEdges() {
        ...
        String string = "I'm not in the graph.";
        assertNull("Edges should be null, since Object was not added to the graph",instance.outgoingEdges(string));
    ...
    public void testIncomingEdges() {
        ...
        String string = "I'm not in the graph";
        assertNull("Vertex was not added to the graph",instance.incomingEdges(string));
    }
    ...
    public void testRemoveVertex() {
        ...
        String string = "I'm not in the graph";
        assertFalse("Removing a vertex that was not added should return false", instance.removeVertex(string));
    }
    ...
    public void testGetKey(){
        ...
        assertEquals(0, graph.getKey(v));
        
        String v1 = "Not in the graph";
        assertEquals(-1, graph.getKey(v1));
    }
    ...
    public void testHashCode(){
        ...
        Graph<String, String> graph = new Graph<>(true);
        graph.insertEdge("Vertex 1", "Vertex 2", " ", 1);
        
        
        Graph<String, String> graph1 = new Graph<>(true);
        graph1.insertEdge("Vertex 1", "Vertex 2", " ", 1);
    ...
    public void testAdjVertices(){
        ...
        Iterable<String> adjVertices = graph.adjVertices(v1);
        ...
        assertEquals(expected, adjVertices);
        
        assertNull(graph.adjVertices("Not in the graph"));
    }
    ...
    public void testToString(){
        ...
        graph.insertEdge(e1, e2, "", 0);
        graph.insertEdge(e2, e3, "", 0);
