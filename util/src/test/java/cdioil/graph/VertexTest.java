...
public class VertexTest {
    ...
    public void testToString() {
        ...
        Vertex<String, Integer> nullInstance = new Vertex<>(42, null);
        assertTrue(nullInstance.toString().isEmpty());
    }
    ...
    public void testHashCode() {
        ...
        Vertex<String, Integer> v1 = new Vertex<>(0, "Element");
        Vertex<String, Integer> v2 = new Vertex<>(v1);

        assertEquals("Equal objects should have the same hashCode", v1.hashCode(), v2.hashCode());
    }

    /**
     * Test of Constructor, of class Vertex
     */
    @Test
    public void testCopyConstructor() {
        ...
        Vertex<String, Integer> vertex = new Vertex<>(0, "Element");
        String adjVertex = "Another element";
        Edge<String, Integer> edge = new Edge<>();
        vertex.addAdjVert(adjVertex, edge);
        
        Vertex<String, Integer> copy = new Vertex(vertex);
        assertEquals(copy.getAllAdjVerts(), vertex.getAllAdjVerts());
    }
