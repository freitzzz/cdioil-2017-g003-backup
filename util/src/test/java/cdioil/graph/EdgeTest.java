...
public class EdgeTest {
    ...
    public void testGetEndpoints() {
        ...
        vertex1 = new Vertex<>(1, null);
        
        instance.setVOrig(vertex1);
        instance.setVDest(vertex1);
        assertNull(instance.getEndpoints());
    }
    ...
    public void testToString() {
        ...
        Vertex<String, String> vertex2 = new Vertex<>(2, "Vertex 2");
        
        Edge<String, String> edge = new Edge<>(" ", 0, vertex1, vertex2);
        
        result = edge.toString().trim();
        expResult = "( ) - Vertex 2";
    ...
    public void testHashCode(){
        ...
        Vertex<String,String> vOrig = new Vertex<>(0, "Element");
        
        Edge<String, String> edge1 = new Edge<>("", 0, vOrig, vOrig);
        
        Edge<String, String> edge2 = new Edge<>("", 0, vOrig, vOrig);
